...
Use the :class:`SnowparkPythonOperator <airflow.providers.snowflake.operators.snowpark>` to execute
Snowpark Python callable functions in a `Snowflake <https://docs.snowflake.com/en/>`__ database.
